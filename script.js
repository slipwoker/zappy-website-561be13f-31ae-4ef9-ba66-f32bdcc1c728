    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "ירון חזן - שמאי רכוש משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '561be13f-31ae-4ef9-ba66-f32bdcc1c728',
                    name: data.name || '',
                    email: data.email || '',
